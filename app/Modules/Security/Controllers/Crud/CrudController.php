...
class CrudController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('Security::crud.list', $this->data);
    }
    ...
    public function create()
    {
        ...
        // load the view from /resources/views/vendor/backpack/crud/ if it exists, otherwise load the one in the package
        return view('Security::crud.create', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        // load the view from /resources/views/vendor/backpack/crud/ if it exists, otherwise load the one in the package
        return view('Security::crud.edit', $this->data);
    }
    ...
    public function show($id)
    {
        ...
        return view('Security::crud.show', $this->data);
    }
    ...
    public function reorder()
    {
        ...
        // load the view from /resources/views/vendor/backpack/crud/ if it exists, otherwise load the one in the package
        return view('Security::crud.reorder', $this->data);
    }
    ...
    public function showDetailsRow($id)
    {
        ...
        // load the view from /resources/views/vendor/backpack/crud/ if it exists, otherwise load the one in the package
        return view('Security::crud.details_row', $this->data);
    }

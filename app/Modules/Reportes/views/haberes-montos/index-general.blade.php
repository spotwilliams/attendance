        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
                <div class="col-md-12 col-xs-12 col-lg-12">
                    @include('Reportes::haberes.form-general')
                </div>
                <hr/>
                ...
                <div class="col-md-12 col-xs-12 table-responsive">
                    ...
                    <table class="table table-hover">
                        @include('Reportes::haberes.result.resumen')

                        <thead>
                        @include('Reportes::haberes.result.table-header')
                        </thead>
                        <tbody>
                        @include('Reportes::haberes.result.table-content')
                        </tbody>

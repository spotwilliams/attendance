    ...
    <div class="content">
        ...
        <div class="box box-danger">
            <div class="box-header">
                <h3 class="box-title">Duplicado de personal masiva</h3>

            </div>
            {!! Form::open(['route' => 'agentesMasivoDuplicadoUpload', 'class'=>'form-horizontal', 'method' => 'POST', 'files' => true]) !!}
            <div class="box-body">
...
{{--                @include('common.bases.as-select-sin-btn' , ['routeName'=>'agentesIndex', 'label'=> 'Seleccione la base', 'baseSeleccionada' => -1])--}}
        ...
        <div class="instrucciones hidden">
            @include('Masivo::agentes.duplicado.advertisment')
        </div>
    </div>

    ...
    <div class="content">
        ...
        <div class="box box-warning">
            <div class="box-header with-border">
                <h3 class="box-title">C&aacute;lculo de haberes para <span class="label label-info">{{trans('month.'.$mesFacturacion->format('m'))}} '{{$mesFacturacion->format('y')}}</span> <span class="label label-default">({{$start->format('d/m/Y')}} - {{$end->format('d/m/Y')}})</span></h3>
            </div>
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Resultados de la b&uacute;squeda: <span class="label label-info">@if(isset($agentes)){{$agentes->count()}}@else{{0}}@endif</span> agentes encontrados</h3>
            </div>
